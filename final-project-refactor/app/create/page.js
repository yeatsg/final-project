    ...
    return <>
        <div className="render-body">
            <Modal shown={failureModalShown} setShown={setFailureModalShown}>
                <p>You're either not currently logged into Spotify<br />or you have not given us appropriate permissions.</p>
                <p>Please follow the link below to use this app.</p>
                <Link href="/api/spotifyLogin">Log in with Spotify</Link>
                <p className="text-disclaimer">Need help? Contact Us</p>
            </Modal>
