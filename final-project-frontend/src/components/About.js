    ...
    <div className="green-pink-bg pink-bubble-bg">
      <div className="text-body">
        ...
        <p>
          ...
          artist royalties based on your streaming data. UN-WRAPPED is inspired
          by the Spotify Wrapped feature which shows users their streaming
          history and behavior over the course of the year.
        </p>
        <p>
